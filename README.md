...
Hi, I'm Feven! I have a technical background and have a Bachelors degree in Health Informatics. After earning my degree, i grew an interest in Data and Analytics and pursued a masters degree in Data Science. These are projects I have done in my spare time.
...
**Description:** Applied the concepts of c# in a video game setting​, how to use Unity packages and reference/instantiate game objects and fields properly​ which include Asset importing and what to look for character rigging​, animations​, how to properly use layers and meshes.
**Technology:** C#  
